...
- To find these correlations, it is necessary to be abel to extract spectral and temporal values from recordings of vocalizations. There are several packages in R which allow us to do this, which we will discuss today.
